...
class QuizQuestionsActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private var mSelOptionPosition:Int = 0
    ...
    private fun selOptionsView(t:TextView, selOptionNum:Int){
        defaultOptionsView()
        mSelOptionPosition = selOptionNum
        t.setTextColor(Color.parseColor("#363A43"))
        ...
        when(view?.id){
            ...
            R.id.submitBtn ->{
                if(mSelOptionPosition == 0){
                    ...
                    if(question!!.correctAns != mSelOptionPosition){
                        answerView(mSelOptionPosition, R.drawable.wrong_option_border_bg)
                    }else{
                        mCorrectAns++
                    }
